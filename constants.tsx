...
export const Icons = {
  ...
  Square: ({ className = "w-5 h-5" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const TAG_SUGGESTIONS = [
  { category: 'Lighting', tags: ['Golden Hour', 'Volumetric Lighting', 'Cyberpunk Neon', 'Soft Bokeh', 'Cinematic Rim Light', 'HDR'] },
  { category: 'Composition', tags: ['Rule of Thirds', 'Isometric View', 'Low Angle', 'Wide Shot', 'Macro Detail', 'Symmetrical'] },
  { category: 'Style', tags: ['Hyper-Realistic', 'Oil Painting', 'Minimalist', 'Surrealism', 'Ukiyo-e', 'Art Nouveau'] },
  { category: 'Technical', tags: ['Unreal Engine 5', '8k Resolution', 'Ray Tracing', 'Octane Render', 'Masterpiece', 'Highly Detailed'] }
];

export const LANGUAGE_EXAMPLES = {
  English: [
    { title: 'Cyberpunk City', keywords: 'Futuristic Tokyo, neon rain, flying cars', tags: ['Cyberpunk Neon', 'Volumetric Lighting', '8k Resolution'] },
    { title: 'Ancient Forest', keywords: 'Enchanted woods, giant mushrooms, fairy lights', tags: ['Soft Bokeh', 'Cinematic Rim Light', 'Macro Detail'] }
  ],
  Hindi: [
    { title: 'Varanasi Ghats', keywords: 'Ganga Aarti, evening lamps, spiritual atmosphere', tags: ['Golden Hour', 'Cinematic Rim Light', 'Highly Detailed'] },
    { title: 'Royal Palace', keywords: 'Rajasthan architecture, intricate carvings, desert sun', tags: ['Rule of Thirds', 'HDR', 'Masterpiece'] }
  ],
  Hinglish: [
