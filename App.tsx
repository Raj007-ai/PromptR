                            ...
                            {generatedImage.urls && generatedImage.urls.length > 1 ? (
                              generatedImage.urls.map((url, idx) => (
                                <div key={idx} className="relative group/item w-full flex items-center justify-center">
                                  ...
                                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover/item:opacity-100 focus-within:opacity-100 transition-opacity rounded-2xl flex items-center justify-center space-x-4 backdrop-blur-sm">
                                    <button onClick={() => downloadImage(url, imagePrompt)} className="p-3 bg-white/10 backdrop-blur-md rounded-full text-white hover:bg-white/20 transition-all focus-visible:ring-2 outline-none" aria-label="Download Image"><Icons.Image /></button>
                                  </div>
                                </div>
                              ))
                            ) : (
                              <>
                                ...
                                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity rounded-3xl flex items-center justify-center space-x-4 backdrop-blur-sm">
                                  <button onClick={() => downloadImage(generatedImage.url, imagePrompt)} className="p-4 bg-white/10 backdrop-blur-md rounded-full text-white hover:bg-white/20 transition-all focus-visible:ring-2 outline-none" aria-label="Download Image"><Icons.Image /></button>
                                </div>
                              </>
                            )}
                          </div>
                            ...
                            <div className="p-6 bg-white/[0.015] rounded-2xl border border-white/5 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] backdrop-blur-md relative group">
                              ...
                              {refinementInstruction && (
                                <button 
                                  ...
                                  className="absolute top-4 right-4 p-2 rounded-full bg-white/5 hover:bg-white/10 text-white/40 hover:text-white/80 transition-all opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 outline-none"
