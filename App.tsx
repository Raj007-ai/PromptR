        ...
        {value && (
          <div className="absolute top-4 right-4 flex space-x-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity z-10">
            {onCopy && (
              <button 
                onClick={onCopy}
                aria-label="Copy to Clipboard" className="p-2 rounded-full bg-white/5 hover:bg-white/10 text-white/40 hover:text-white/80 transition-all focus-visible:ring-2 outline-none"
            ...
            <button 
              onClick={onClear}
              aria-label="Clear Keywords" className="p-2 rounded-full bg-white/5 hover:bg-white/10 text-white/40 hover:text-white/80 transition-all focus-visible:ring-2 outline-none"
                        ...
                        {activeImageOutputTab === 'materialized' && (
                          <div className="relative group w-full flex-1 flex items-center justify-center">
                            ...
                            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity rounded-3xl flex items-center justify-center space-x-4 backdrop-blur-sm">
                              <button onClick={() => downloadImage(generatedImage.url, imagePrompt)} aria-label="Download generated image" className="p-4 bg-white/10 backdrop-blur-md rounded-full text-white hover:bg-white/20 transition-all focus-visible:ring-2 outline-none"><Icons.Image /></button>
                            </div>
                          </div>
                        )}
                            ...
                            <div className="p-6 bg-white/[0.015] rounded-2xl border border-white/5 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] backdrop-blur-md relative group">
                              ...
                              {refinementInstruction && (
                                <button 
                                  ...
                                  aria-label="Clear Instructions" className="absolute top-4 right-4 p-2 rounded-full bg-white/5 hover:bg-white/10 text-white/40 hover:text-white/80 transition-all opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 outline-none"
                  ...
                  {!styleAnalysisInput.image ? (
                    ...
                    <div className="relative h-40 rounded-[2.5rem] overflow-hidden border border-white/10 group shadow-2xl">
                      ...
                      <button 
                        ...
                        aria-label="Clear Style Image" className="absolute top-4 right-4 p-3 bg-red-500/90 rounded-full hover:bg-red-500 hover:scale-110 transition-all z-10 text-white opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 outline-none translate-y-[-10px] group-hover:translate-y-0 shadow-lg"
                      >
                        <Icons.X className="w-4 h-4" />
                      </button>
                    </div>
                    ...
                    <div className="relative group">
                      ...
                      {styleAnalysisInput.description && (
                        <button 
                          ...
                          aria-label="Clear Description" className="absolute top-4 right-4 p-2 rounded-full bg-white/5 hover:bg-white/10 text-white/40 hover:text-white/80 transition-all opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 outline-none"
