        ...
        {value && (
          <div className="absolute top-4 right-4 flex space-x-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity z-10">
            {onCopy && (
              <button 
                onClick={onCopy}
                className="p-2 rounded-full bg-white/5 hover:bg-white/10 text-white/40 hover:text-white/80 focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:outline-none transition-all"
                        ...
                        {activeImageOutputTab === 'materialized' && (
                          <div className="relative group w-full flex-1 flex items-center justify-center">
                            ...
                            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity rounded-3xl flex items-center justify-center space-x-4 backdrop-blur-sm">
                              <button onClick={() => downloadImage(generatedImage.url, imagePrompt)} aria-label="Download Image" title="Download Image" className="p-4 bg-white/10 backdrop-blur-md rounded-full text-white hover:bg-white/20 focus-visible:ring-4 focus-visible:ring-white/50 focus-visible:outline-none transition-all"><Icons.Image /></button>
                            </div>
                          </div>
                        )}
                            ...
                            <div className="p-6 bg-white/[0.015] rounded-2xl border border-white/5 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)] backdrop-blur-md relative group">
                              ...
                              {refinementInstruction && (
                                <button 
                                  ...
                                  className="absolute top-4 right-4 p-2 rounded-full bg-white/5 hover:bg-white/10 text-white/40 hover:text-white/80 transition-all opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:outline-none"
                    ...
                    <div className="relative group">
                      ...
                      {styleAnalysisInput.description && (
                        <button 
                          ...
                          className="absolute top-4 right-4 p-2 rounded-full bg-white/5 hover:bg-white/10 text-white/40 hover:text-white/80 transition-all opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-blue-500/50 focus-visible:outline-none"
