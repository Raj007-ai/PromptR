...
export const ShareModal: React.FC<ShareModalProps> = ({ isOpen, onClose, promptText, title = "Generated Prompt" }) => {
  ...
  const handleExportText = () => {
    ...
    a.href = url;
    a.download = `${title.replace(/[^a-z0-9]/gi, '_').toLowerCase()}_prompt.txt`;
        ...
        >
          ...
          >
            <div className="flex items-center justify-between p-6 border-b border-white/5">
              ...
              <button aria-label="Close" onClick={onClose} className="p-2 text-[var(--text-muted)] hover:text-[var(--text-main)] transition-colors rounded-full hover:bg-white/5">
            ...
            <div className="p-6 space-y-8 flex-1 overflow-y-auto">
              ...
              <div className="pt-4 border-t border-white/5">
                <button 
                  ...
                  className="w-full py-4 bg-white/5 border border-white/10 rounded-2xl text-[10px] font-black uppercase tracking-widest text-[var(--text-main)] flex items-center justify-center space-x-2 hover:bg-white/10 transition-all"
                >
